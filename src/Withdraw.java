	...
	public void doWithdraw(){
		// Withdraw test
		   ...
		   if (w.checkCourseEnroll(withdraw_ccode)){
			   ...
			   w.checkafterwithdraw(withdraw_ccode, year, quarter);
	  ...
	  public void checkafterwithdraw(String CCode, String yearNow,String quarterNow){
			...
			try{
			      ...
			      String sql;
			      sql = "SELECT UoSCode, Semester , Year from belowMaxEnrollment Where UoSCode = '" + CCode + "'and year = " + yearNow + " and Semester = '" +quarterNow + "';" ;
			      ...
			      while (rs.next()){
			    	  ...
			    	  if (year.equals(yearNow) && quarter.equals(quarterNow)){
			    		  System.out.println("Warning: The number of enrollments of this course is below 50%!");
			    	  }
			      }
